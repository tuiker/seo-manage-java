 ...
 */
/**
 *  -->下面重写Redis的配置类，解决序列化乱码问题
 *  -->编写自己的redisTemplate的序列化方式
 *  -->下面的redisTemplate就是一个模板，以后关于Redis的序列化问题，
 *  此RedisConfig类，直接拿来使用即可！
 *
 */
...
public class RedisConfig {
    ...
    public RedisTemplate<String, Object> redisTemplate1(RedisConnectionFactory factory)
        ...
        jackson2JsonRedisSerializer.setObjectMapper(om); //过时
