...
public class PhoneUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(PhoneUtil.getPhoneNumberInfo("+85268476749").get("nationalNumber"));

        // {"number":"16467879865","regionCode":"US","nationalNumber":6467879865,"countryCode":1,"description":"美国","fullNumber":"+16467879865"}
        System.out.println(PhoneUtil.getPhoneNumberInfo("+16467879865"));

        // The phone number maybe like:+[National Number][Phone number], but got +86155xxxx331
        System.out.println(PhoneUtil.getPhoneNumberInfo("+8615556600331"));
    }
}
